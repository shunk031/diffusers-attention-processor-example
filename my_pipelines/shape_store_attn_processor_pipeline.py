...
class ShapeStoreAttnProcessor(AttnProcessor):
    def __init__(self):
        super().__init__()
...
class ShapeStoreAttnProcessorPipeline(StableDiffusionPipeline):
    def register_attn_processor(self) -> None:
        self.unet.set_attn_processor(ShapeStoreAttnProcessor())

    @torch.no_grad()
    def __call__(self, *args, **kwargs):
        self.register_attn_processor()
